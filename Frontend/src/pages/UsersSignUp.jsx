...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const data = await registerUser({ email, password, roletype });
    ...
    <>
      ...
      <main className="login-container">
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <div className="separator">Or, sign up with your email</div>
          ...
          <label htmlFor="roletype" className="form-label" style={{ marginTop: "15px" }}>
            Role Type
          </label>
          <select
            id="roletype"
